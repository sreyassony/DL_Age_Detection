...
from data_loader import Transforms_Dataloader
from model import resnet18, niu_model, niu_forback, niu_modified
...
def main():
    ...
    print(f'batch_size= {len_train_dataset//BATCH_SIZE}')
    #####################################
    #           TRAINING
    #####################################
